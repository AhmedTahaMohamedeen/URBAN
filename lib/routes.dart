...
import 'package:urban/screens/home.dart';
...
Map<String,WidgetBuilder>routes={
  ...
  MaterialSectionsScreen.route:(context)=>const MaterialSectionsScreen(category: ''),
  MaterialCompaniesScreen.route:(context)=>const MaterialCompaniesScreen(category: '',section: '',kind: ''),
  MaterialKindsScreen.route:(context)=>const MaterialKindsScreen(category: '',section: ''),
  ProductsScreen.route:(context)=>const ProductsScreen(company: '',kind: '',section: '',category: ''),
  AddProductScreen.route:(context)=>const AddProductScreen(company: '',kind: '',section: '',category: ''),
  ...
  EquipmentsViewScreen.route:(context)=> const EquipmentsViewScreen(kind: '',company: ''),
  AddEquipmentScreen.route:(context)=> const AddEquipmentScreen(kind: '',company: ''),
  EquipmentsCompaniesScreen.route:(context)=> const EquipmentsCompaniesScreen(kind: ''),
  ...
  CompanyDetailsScreen.route:(context)=>    const CompanyDetailsScreen(company: ''),
  ...
  SelectWorkerScreen.route:(context)=>     SelectWorkerScreen(requestWorker: RequestWorker()),
  ...
  AdminChatScreen.route:(context)=>     AdminChatScreen(myUser: MyUser(),),
