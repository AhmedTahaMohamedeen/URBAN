...
import 'admin/admin_messages-list.dart';
...
class _HomeState extends State<Home> {
       ...
       Scaffold(body: Center(child:myCircularIndicator(context)))
        ...
        child: Consumer<NotifyProvider>(
          builder: (context,NotifyProvider noty,child) {
            if(!Provider.of<FireProvider>(context,listen: false).isAdmin!){


              if(!isChecked){noty.checkNoty(myId:Provider.of<FireProvider>(context,listen: false).myId! ); isChecked=true;print('check');}}
                ...
                Stack(
                  children: [
                    ...
                    const Positioned(
                      ...
                      bottom: 0,
                      child: Image(
                        image:AssetImage( 'assets/images/homeBackground.png'),fit: BoxFit.fill
                      ),
                    ),
                    Padding(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        _item(text: '${getLang(context, "cart")}'
                            ,onTap: ()async{
                            await Provider.of<NotifyProvider>(context,listen: false).enterCarts();
                          //  print( Provider.of<NotifyProvider>(context,listen: false).currentCarts);
                          Navigator.pushNamed(context, CartsScreen.route);
                          },
                            image: 'cart',
                          noty: noty.cartsNoty==null||noty.cartsNoty==false?false:true,),


                        _item(text: '${getLang(context, "orders")}'
                            ,onTap: ()async{
                            await Provider.of<NotifyProvider>(context,listen: false).enterOrders();
                          Navigator.pushNamed(context, UserOrdersScreen.route);},
                            image: 'orders',
                          noty: noty.orderedNoty==null||noty.orderedNoty==false?false:true,),


                        _item(text: '${getLang(context, "workers")}'
                            ,onTap: ()async{
                            await Provider.of<NotifyProvider>(context,listen: false).enterRequests();
                          Navigator.pushNamed(context, UserWorkersScreen.route);},
                            image: 'userWorker',
                          noty: noty.requestedNoty==null||noty.requestedNoty==false?false:true,),


                        _item(text: '${getLang(context, "experts")}'
                            ,onTap: (){
                            setState(() {
                              messageIsSeen=true;
                            });
  ...
  _homeItem({required String name,required String imageUrl,required double height,required VoidCallback onTap}){
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: InkWell(
            ...
            child: Stack(
              children: [
                ...
                Center(
                  child: Text(name,
                  style: TextStyle(
                      color: Colors.white,fontSize: height*.02,fontWeight: FontWeight.w900,
                ...
                Provider.of<FireProvider>(context,listen: false).isAdmin!?const SizedBox():   const Positioned(
                  top: 0,

                  child: const Icon(Icons.radio_button_checked_outlined,color:Colors.red),
                )
              ],
            ),
  ...
  Widget _item({required VoidCallback onTap,required String text,required String image,required bool noty}){
              ...
              child: Material(
                ...
                child: Stack(
                  children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              ...
                              child: Image(image: AssetImage('assets/images/homeIcons/$image.png'),),
                    ...
                    noty?  const Positioned(
                      top: 0,

                      child: Padding(
                        padding: EdgeInsets.all(2.0),
                        child: Icon(Icons.notifications_on_rounded,color:Colors.red,size: 15),
                      ),
                    ):const SizedBox()
                  ],
                ),
...
class _HomeUserState extends State<HomeUser> {
  ...
  Widget build(BuildContext context) {
    ...
    bool? isAdmin=Provider.of<FireProvider>(context,listen: false).isAdmin;
    return InkWell(
      onTap: (){
        Navigator.pushNamed(context, UserProfileScreen.route);
      },
      child:
      userInfoo==null?myCircularIndicator(context)
          :
      Row(
        children: [
          Padding(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: CachedNetworkImageProvider(userInfoo!.photo!,),fit: BoxFit.fill)
              ),
            )
                :
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  shape: BoxShape.circle,
                color: Colors.black,
                  border: Border.all(color: Theme.of(context).appBarTheme.backgroundColor!,width: 2,style: BorderStyle.solid),),
     ...
     /*    isAdmin!? Text('${getLang(context, "admin")}',style: TextStyle(
         ...
         Row(
            children: [
              Text('${getLang(context, "welcome")} ,',style: TextStyle(
                  color: Theme.of(context).appBarTheme.backgroundColor!,
                  fontSize: height*.018),),
              ...
              SizedBox(
                ...
                child: Text(
                  ...
                  fontSize: height*.018,fontWeight: FontWeight.w800,),
