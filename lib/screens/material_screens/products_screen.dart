                                 ...
                                 Dialog(
                                   ...
                                   child: SizedBox(
                                     ...
                                     child: Column(
                                       ...
                                       children: [
                                         Center(child: Text('${getLang(context, "are you sure")}',style: TextStyle(fontWeight: FontWeight.w900,color: Colors.white ),)),
                                         Row(
                                           mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                               children: [
                                           EbottonI(
                                       ...
                                       EbottonI(
                                           ...
                                           child:  Text('${getLang(context, "no")}',style: TextStyle(color: Colors.black)),
