...
class _AdminRequestsScreenState extends State<AdminRequestsScreen> {
  ...
  getAllRequests()async{
    ...
    setState(() {
      requestingList=allRequests1.where((element) => element.status==requesting).toList();
      requestedList=allRequests1.where((element) => element.status==requested).toList();
    });
    print(requestingList!.length);
    print(requestedList!.length);
    print(allRequests1.length);
                ...
                child: InkWell(
                        ...
                        Dialog(
                          ...
                          child: SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                Center(child: Text('${getLang(context, "are you sure")}',style: const TextStyle(fontWeight: FontWeight.w900,color: Colors.black ),)),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                  children: [
                                    EbottonI(
                  ...
                  child:  Material(
                    ...
                    child: Padding(
                      ...
                      child: Icon(Icons.cancel,color: Colors.redAccent.withOpacity(.5)),
                    ),
                  ),
                ),
              ),
              Row(
                ...
                children: [
                  ...
                  Material(
                      ...
                      child:InkWell(
                        onTap: ()async{
                          await Navigator.push(context,MaterialPageRoute(builder: (context) => SelectWorkerScreen(requestWorker: requestWorker),)).then((value) =>  getAllRequests());
                        ...
                        child: SizedBox(
                            ...
                            child:  Padding(
                              ...
                              child: Center(child: Text('${getLang(context, "select worker")}')),
                            )),
                      ))
                ],
              ),
                    ...
                    Row(
                      children: [
                        ...
                        ChangeNotifierProvider(
                          ...
                          child:  Consumer<LangProvider>(
                              builder: (context,LangProvider lanNoty,child) {
                                return  Text(lanNoty.isEn?city.en!:city.ar!,style:valueStyle,) ;
                              }
                          ),
                        ),
                    ...
                    children: [
                      InkWell(
                        ...
                        child:  Material(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(3.0),
                            child: Icon(Icons.change_circle,color: Colors.red.withOpacity(.5)),
                          ),
                        ),
                      ),//change
