      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            SizedBox(
                width: width*.5,
                child: Text(widget.myUser.name!)),
            SizedBox(width: 20),
            widget.myUser.photo!=null? CircleAvatar(
              backgroundImage: CachedNetworkImageProvider(widget.myUser.photo!),
              radius: 20,
            ):
            Material(
                ...
                child: CircleAvatar(
                 ...
                 // radius: 30,
                  ...
                  child: Text(
                    ...
                    ,style: TextStyle(color: Colors.white,fontSize: height*.025),),
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: StreamBuilder< QuerySnapshot<Map<String, dynamic>>>(
                    stream:  Message().streamAdminGetMessages( userId:  widget.myUser.id!),
                      ...
                      child: SizedBox(
                        ...
                        child: Form(
                          ...
                          child: MyMessageTextField(
                            ...
                            vFuntion: (v){if(v!.isEmpty){return'enter details';}return null;},
                          ...
                          onTap: ()async{
                            ...
                            if(_myKey.currentState!.validate()){
                              ...
                              if(await Message().adminSendMessage(Message(
                               ...
                               await Message().adminMakeChatSeen(userId: widget.myUser.id!);
