...
class _AdminMessagesListState extends State<AdminMessagesList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:   myUsersMessages==null?myShimmer(context):  Stack(
        children: [
          ListView.builder(
            ...
            itemBuilder: (context, index) => UserChatUnit(user:  myUsersMessages![index],),),
          NewFloatingAdmin()
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        await   Navigator.push(context, MaterialPageRoute(builder: (context) => AdminChatScreen(myUser:  widget.user),)).then((value) => adminCheckSeen() );
        },
        child:  Material(
          elevation: 5,
          ...
          child: Row(
            ...
            children: [
                  ...
                  Padding(
                    ...
                    child: Material(
                      ...
                      child: Padding(
                        ...
                        child:widget.user.photo!=null? CircleAvatar(
                        ...
                        CircleAvatar(
                          ...
                          child: Text(
                            ...
                            ,style: TextStyle(color: Theme.of(context).appBarTheme.backgroundColor,fontSize: height*.025),),
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: Text(widget.user.name!,
                        style: TextStyle(
                            color: adminIsSeen? Colors.black.withOpacity(.5):Theme.of(context).appBarTheme.backgroundColor,
                            fontSize: 18,
              ...
              adminIsSeen?const SizedBox(): Padding(
                padding: const EdgeInsets.all(8.0),
                child: Row(
                  children: [

                    Text('${getLang(context, "new message")}',style: TextStyle(color: Theme.of(context).appBarTheme.backgroundColor,fontSize: height*.01,fontWeight: FontWeight.bold),),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Icon(Icons.message,color:Theme.of(context).appBarTheme.backgroundColor,size: height*.02),
                    ),
                  ],
                ),
              )
