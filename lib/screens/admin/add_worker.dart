          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                AddWorkerTextField(
                  label: 'Full-name',
                  vFuntion: (v){if(v!.isEmpty){return'enter your name';}return null;},
                            ...
                            Material(
                              ...
                              child: DropdownButton(
                                ...
                                items:Governorate().getGovernorates() .map((e) =>
                                    DropdownMenuItem(child: Text(lanNoty.isEn?e.en!:e.ar!,style: const TextStyle(fontSize: 12,color: Colors.white),), value: e.id,)).toList(),
                ...
                Material(
                  ...
                  child: DropdownButton(
                    ...
                    items: workersCategories .map((e) =>
                        DropdownMenuItem(child: Text('${getLang(context, e)}',style: const TextStyle(fontSize: 12,color: Colors.white),), value: e,)).toList(),
  ...
  Widget _saveButton({required BuildContext context,required double height}){
    return InkWell(
        ...
        child: Container(
          ...
          alignment: Alignment.center,
          child:  Text('إضافه عامل',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700,fontSize: height*.018),
...
class AddWorkerTextField extends StatelessWidget {
