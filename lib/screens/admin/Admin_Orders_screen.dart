...
class _AdminOrdersScreenState extends State<AdminOrdersScreen> {
    ...
    try{
      ...
      setState(() {
        ...
        //myOrderingProductsCarts=myCarts1.where((element) => element.status==ordering&&element.equip==null).toList();
         orderedProductsCarts=carts1.where((element) => element.status==ordered&&element.equip==null).toList();
        orderedEquipmentsCarts=carts1.where((element) =>element.equip!=null&&element.status==ordered).toList();
          ...
          body:  Stack(
            children: [
              TabBarView(
                ...
                children: [
                  orderedProductsCarts==null?myShimmer(context):  CustomScrollView(
                    slivers: [
                      ...
                      SliverPadding(
                        ...
                        sliver: SliverGrid(
                          delegate: SliverChildBuilderDelegate(
                              ...
                              return
                                _sellingCartItem(
                                    height: height, cart: orderedProductsCarts![index]);
                  ...
                  orderedEquipmentsCarts==null?myShimmer(context): CustomScrollView(
                    slivers: [
                        ...
                        flexibleSpace: Row(
                          ...
                          children: [
                            ...
                            Material(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(16.0),
                                child: Text('سوف يتم التواصل معك بواسطه الشركه لتأكيد طلبك  ',style: TextStyle(
                                    color: Colors.white,
                                    fontSize: height*.018
                                ),),
                              ),
                      ...
                      SliverPadding(
                        ...
                        sliver: SliverGrid(
                          delegate: SliverChildBuilderDelegate(
                              ...
                              return
                                _equipmentCartItem(
                                    height: height, cart: orderedEquipmentsCarts![index]);
  ...
  _sellingCartItem({required double height,required Cart cart}){
    TextStyle nameStyle= TextStyle(color: Colors.black.withOpacity(.7),fontWeight: FontWeight.w400,fontSize: height*.012);
    TextStyle valueStyle= TextStyle(color: Colors.black.withOpacity(.7),fontWeight: FontWeight.w400,fontSize: height*.012);
                ...
                children: [
                  Center(
                    ...
                    Container(
                      ...
                      child:  Text('${getLang(context, "not available")}',style: TextStyle(color: Colors.black),),
                  ...
                  Center(child: Padding(
                    ...
                    child: Text(cart.product![productName],style: TextStyle(fontSize: height*.018,fontWeight: FontWeight.bold,color: Colors.black),maxLines: 1,overflow: TextOverflow.visible),
                  )),
                  Material(
                    color: Theme.of(context).primaryColor,
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                ...
                                ,style: TextStyle(color: Colors.black.withOpacity(1),fontWeight: FontWeight.w400,fontSize: height*.018),),
                            ],
                          ),
                        ],
                      ),
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          EbottonI(
                            onpressed: ()async{
                              ...
                              await Cart().editCart(cartId: cart.id!, map: {cartIsAccepted:true});
                              await getAllCarts();
                            ...
                            child: Text('${getLang(context, "accept")}',style: TextStyle(fontSize: height*.016,color: Colors.green)),
                            icon: Icon(Icons.done,size: height*.018,color: Colors.green),
                            elevation: 2,
                            borderRadius: 10,
                            ...
                            borderColor: Colors.black.withOpacity(.1),
                              ...
                              children:  [
                                ...
                                Text('${getLang(context, "accepted")}',style: TextStyle(color: Colors.green,fontSize: height*.016),)
                    ...
                    Padding(
                      ...
                      EbottonI(
                        ...
                        child: Text('${getLang(context, "cancel")}',style: TextStyle(fontSize: height*.016,color: Colors.red)),
                        icon: Icon(Icons.close,size: height*.018,color: Colors.red),
                        elevation: 2,
                        borderRadius: 10,
                        overColor: Colors.red,
                        padding: height*.008,
                     ...
                     children: [
                       ...
                       EbottonI(
                         ...
                         borderColor: Colors.black.withOpacity(.1),
                           ...
                           children:  [
                             Icon(Icons.done_all,color: Colors.green,size: 20),
                             Text('${getLang(context, "accepted")}',style: TextStyle(fontSize: height*.016,color: Colors.green),)
