...
class _AdminWorkersScreenState extends State<AdminWorkersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: allWorkers==null?myShimmer(context):
     Stack(
       children: [
         ListView.builder(
           itemCount: allWorkers!.length,
           padding: const EdgeInsets.all(8),
           itemBuilder: (context, index) => workerItem(worker:allWorkers![index] ,height: height) ,
         ...
         Positioned(
           ...
           child: InkWell(
             ...
             onTap: ()async{
               ...
               await Navigator.pushNamed(context, AddWorkerScreen.route).then((value) =>getAllWorkers());
             ...
             child: Material(
               ...
               child: Padding(
                 ...
                 child: Center(
                   child: Text('${getLang(context, "add worker")}',style: const TextStyle(color: Colors.white),
                   ),
                 ),
               ),
             ),
                      ...
                      child: Row(
                        ...
                        children:  [
                          Padding(
                            ...
                            child: Text(worker.name!,style: TextStyle(color: Colors.black,fontSize: height*.02),),
                          ),
                           Material(
                             elevation: 3,
                             color: Theme.of(context).primaryColor,
                              ...
                              children: [
                                Row(
                                  children:  [
                                    ...
                                    Text('${getLang(context, worker.category!)}',style: nameStyle,),
                                  ],
                                ),
                ...
                child: InkWell(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Ebotton(
                                      onpressed: ()async{
                                        await Worker().removeWorker(workerId: worker.id!);
                  ...
                  child: Material(
                    ...
                    child: Padding(
                      ...
                      child: Icon(Icons.delete_forever_sharp,color: Colors.red.withOpacity(.5)),
                    ),
                  ),
                ),
              ),
