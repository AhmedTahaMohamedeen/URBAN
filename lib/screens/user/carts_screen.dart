...
import '../equipments_screens/equipments_details.dart';
...
//selling
                      ...
                      Material(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children:  [
                               Text('${getLang(context, "total price")} : ',style: TextStyle(color: Colors.white,),),
            ...
            Provider.of<FireProvider>(context,listen: false).isAdmin!?NewFloatingAdmin(): NewFloatingUser()
          ],
        ),
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: EbottonI(
                                            ...
                                            child:  Text('${getLang(context, "cash")}',style: TextStyle(color: Colors.white)),
                                        ...
                                        Padding(
                                          ...
                                          child: EbottonI(
                                            ...
                                            child:  Text('${getLang(context, "visa")}',style: TextStyle(color: Colors.white)),
                    ...
                    child: Row(
                      ...
                      children: [
                       ...
                       cart.status!=selling?
                        ...
                        Text('${getLang(context, "ordered")}',style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold),):
                       Ebotton(
                            onpressed: ()async{
