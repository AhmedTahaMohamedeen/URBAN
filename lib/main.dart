...
void main()async {
  ...
  if (login==null||login==false)   {screen=SigningScreen.route;  FlutterNativeSplash.remove();}
  else{
        ...
        builder: (context,LangProvider lanNoty,child) {
          ...
          return MaterialApp(
            ...
            localeResolutionCallback: (currentLang,supportLang){
              ...
              if(currentLang==null){return supportLang.first;}
              else{ return currentLang;}

            },
            locale:lanNoty.isEn? Locale('en',''): Locale('ar','')
            //locale
            ,
